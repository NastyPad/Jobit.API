...
public interface IUserProfileTechSkillService
{
    ...
    Task<UserProfileTechSkillResponse> AddUserTechSkillAsync(UserProfileTechSkill newUserProfileTechSkill);
    Task<UserProfileTechSkillResponse> UpdateUserTechSkillAsync(long userId, UserProfileTechSkill updatedUserProfileTechSkill);
