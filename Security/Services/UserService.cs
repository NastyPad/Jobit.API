...
public class UserService : IUserService
{
    ...
    public UserService(IUserProfileRepository userProfileRepository, IUserRepository userRepository, IUnitOfWork unitOfWork, IMapper mapper)
    {
    ...
    public async Task RegisterUserAsync(RegisterUserRequest registeredUserRequest)
    {
        ...
        try
        {
            await _userRepository.AddAsync(user); // Id will be autogenerated on add (Review db context)
    ...
    public async Task GenerateUserProfileAsync(long userId)
    {
        ...
        try
        {
            ...
            UserProfile starterUserProfile = new UserProfile(username!, firstname, lastname, userId);
            await _userProfileRepository.AddUserProfileAsync(starterUserProfile);
        }
        catch (Exception exception)
        {
